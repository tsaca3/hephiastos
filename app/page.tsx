  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0d0b08', color: '#e8dcc8', fontFamily: 'Crimson Text, serif' }}>
      <nav style={{
        ...
        <span style={{ fontFamily: 'Cinzel Decorative, serif', fontSize: '1.1rem', color: '#e8b84b' }}>HéphIAstos</span>
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <span style={{ fontFamily: 'Cinzel, serif', fontSize: '0.75rem', color: '#7dd6ff' }}>💎 {credits} crédits</span>
          <button onClick={() => router.push('/compte')} style={{
            background: 'transparent', border: 'none',
            color: '#c9922a', fontFamily: 'Cinzel, serif',
      ...
      <div style={{ textAlign: 'center', padding: '100px 40px 60px' }}>
        <p style={{
          ...
          color: '#c9922a', marginBottom: '16px'
        ...
        <p style={{ color: '#7a6a52', fontStyle: 'italic', fontSize: '1.1rem', marginBottom: '40px' }}>
          Bienvenue, {user.email}
        </p>
        <button onClick={() => router.push('/catalogue')} style={{
          background: 'linear-gradient(135deg,#8b2020,#a82828)', color: '#f5d06e',
          border: 'none', padding: '14px 40px', fontFamily: 'Cinzel, serif',
